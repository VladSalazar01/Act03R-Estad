...
#Filtrar las columnas de la expresion genica
...
## 2.1 Interpretación de los eigenvalue, variance.percent y cumulative.variance.percent
...
## 2.2 Interpretación del componente varianza explicada y varianza acumulada
...
## 2.3 Explicación del 70% de la varianza
...
## 2.4 Explicación del Scree Plot
...
## 2.5 Explicación del Cos Dimension 1-2
...
## 2.6 Explicación de la contribución de variables en la Dimension 1
...
## 2.7 Explicación del PCA Expresión Génica
...
## 2.8 Explicación de la carga de los componentes
